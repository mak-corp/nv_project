...
from nv_lib.logger import setup_logging
from nv_lib.utils import read_json, write_json, ROOT_PATH
...
class ConfigParser:
    ...
    def get_default_configs(cls):
        config_path = ROOT_PATH / "nv_lib" / "config.json"
        with config_path.open() as f:
            return cls(json.load(f))

    @classmethod
    def get_test_configs(cls):
        config_path = ROOT_PATH / "nv_lib" / "tests" / "config.json"
        with config_path.open() as f:
            return cls(json.load(f))
